...
MD_MPI            = "/home/rklinds/codes/chimes_calculator-myLLfork/etc/lmp/build/lammps_stable_29Oct2020/src/lmp_mpi_chimes" # For testing -- once we're happy with everything, update the chimes_calculator ALD repos
